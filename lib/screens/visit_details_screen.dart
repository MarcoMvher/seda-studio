...
// import 'package:geolocator/geolocator.dart'; // Requires Flutter upgrade
...
class _AddMeasurementDialogState extends State<AddMeasurementDialog> {
  ...
  Future<void> _handleSubmit() async {
    if (_formKey.currentState!.validate()) {
      ...
      // DISABLED: Requires Flutter upgrade for geolocator compatibility
      double? latitude;
      double? longitude;

      // TODO: Enable after Flutter upgrade
